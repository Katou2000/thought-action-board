...
const DEFAULT_NAV=["home","calendar","routine","builder","freeboard","shortcuts","memo","archive","templates","achievedGoals","trash"];
...
function showTransient(view){data.view=view;views.forEach(v=>{E[v+"View"]?.classList.toggle("hidden",v!==view);E[v+"Button"]?.classList.toggle("active",v===view)});renderSidebar();renderView()}
