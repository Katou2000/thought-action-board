...
function openImageLightbox(src,alt="画像"){if(!src)return;lightboxPreviousFocus=document.activeElement;E.imageLightboxImage.src=src;E.imageLightboxImage.alt=alt;E.imageLightbox.classList.remove("hidden");document.body.classList.add("image-lightbox-open");E.imageLightboxClose.focus()}
...
function renderFreeboard(){
  ...
  p.items.forEach(i=>{
    ...
    if(i.type==="image"){const img=document.createElement("img");img.src=i.content;img.alt="自由帳画像";img.draggable=false;img.className="image-preview-trigger";img.onclick=e=>{e.stopPropagation();openImageLightbox(i.content,"自由帳画像")};body.appendChild(img)}else body.textContent=i.content;
...
function bindEnhancements(){
  ...
  E.freeItemImagePreview.onclick=()=>openImageLightbox(E.freeItemImagePreview.src,"自由帳画像");
