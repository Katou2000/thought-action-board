...
d.quickMemos=Array.isArray(d.quickMemos)?d.quickMemos:[];d.quickMemos.forEach(m=>{m.id=m.id||uid();m.title=m.title||"";m.content=m.content||"";m.pinned=!!m.pinned;m.createdAt=m.createdAt||m.updatedAt||Date.now();m.updatedAt=m.updatedAt||m.createdAt});if(!d.quickMemos.some(m=>m.id===d.selectedQuickMemoId))d.selectedQuickMemoId=d.quickMemos[0]?.id||null;
