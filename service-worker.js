const CACHE_NAME = "task-kanrinner-v1-1-1-features-1";
const APP_FILES=["./","./index.html","./style.css","./script.js","./cloud-sync.js","./supabase-config.js","./manifest.json","./icon-192.png","./icon-512.png"];
