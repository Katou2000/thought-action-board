const CACHE_NAME = "task-kanrinner-v1-3-ui-flow";
const APP_FILES=["./","./index.html","./style.css","./script.js","./ux-v2.js","./cloud-sync.js","./supabase-config.js","./manifest.json","./icon-192.png","./icon-512.png"];
