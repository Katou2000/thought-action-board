...
(()=>{
  ...
  renderBoards=function(){
    ...
    data.boards.forEach((boardValue,index)=>{
      ...
      const main=document.createElement("button");main.type="button";main.className="board-overview-main";main.innerHTML=`<strong>${esc(boardValue.name)}</strong><small>${boardTaskCount(boardValue)}</small>`;main.onclick=()=>selectBoard(boardValue.id);
